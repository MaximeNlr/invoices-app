            ...
            <div className="flex flex-col gap-5 px-5 pt-5">
                {data.map((i) => (
                    <article
                        ...
                        className="flex flex-row justify-between bg-white dark:bg-[var(--custom-dark-color)]
                         dark:text-white rounded-lg px-5 py-5 cursor-pointer hover:scale-110 transition-transform"
                    >
                        ...
                        <div className="flex flex-col justify-between">
                            ...
                            <p
                                ...
                                className={i.status === "paid"
                                    ? "flex justify-center items-center gap-2 text-[#33D69F] bg-[#33D69F]/20 px-5 py-2 text-center rounded-lg font-semibold w-[104px] h-[40px]"
                                    : "flex justify-center items-center gap-2 text-[#FF8F00] bg-[#FF8F00]/20 px-5 py-2 text-center rounded-lg font-semibold w-[104px] h-[40px]"}
                            >
